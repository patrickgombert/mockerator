...
defmodule MockeratorTest do
  ...
  test "it builds a no arity function" do
    module = Mockerator.build(TestMock1, [{:func, 0, "response"}])
    module.start
  ...
  test "it builds a single arity function" do
    module = Mockerator.build(TestMock2, [{:func, 1, "response"}])
    module.start
  ...
  test "it builds a multiple arity function" do
    module = Mockerator.build(TestMock3, [{:func, 3, "response"}])
    module.start
  ...
  test "it builds multiple functions" do
    module = Mockerator.build(TestMock4, [{:func, 0, "response"}, {:other_func, 0, "other response"}])
    module.start
    assert module.func == "response"
